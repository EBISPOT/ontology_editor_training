 ...
 * [wine.yml](wine.yml)
     * Determines how your purl.obolibrary.org/obo/wine/ redirects will be handled
     ...
     * Paste in the contents of [wine.yml](wine.yml)
 ...
 * [wine.md](wine.md)
     ...
     * Paste in the contents of [wine.md](wine.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
