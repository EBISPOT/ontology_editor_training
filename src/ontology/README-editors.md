These notes are for the EDITORS of wine
...
Make sure you have an ID range in the [idranges file](wine-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [wine-edit.owl](wine-edit.owl)

** DO NOT EDIT wine.obo OR wine.owl in the top level directory **

[../../wine.owl](../../wine.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/EBISPOT/ontology_editor_training) for details.
 ...
 * [wine-idranges.owl](wine-idranges.owl)
...
This generates derived files such as wine.owl and wine.obo and places
 ...
 * https://github.com/EBISPOT/ontology_editor_training/releases
 * https://github.com/EBISPOT/ontology_editor_training/releases/new
...
what is in the `owl:versionIRI` of the derived wine.owl (`data-version` in
wine.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/wine.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/wine/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/EBISPOT/ontology_editor_training.svg?branch=master)](https://travis-ci.org/EBISPOT/ontology_editor_training)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/EBISPOT](https://travis-ci.org/profile/EBISPOT)
 2. click the "Sync account" button
 3. Click the tick symbol next to ontology_editor_training
